/*Our colleagues have been looking over you shoulder. When you should have been doing your boring real job, 
...
If <= 5, return 'Get Out Now!'. Else return 'Nice Work Champ!'.Happiness rating will be total score / number of people in the room.
...
for (key in meet){
  ...
  return answer/number<=5? 'Get Out Now!':'Nice Work Champ!'
}
